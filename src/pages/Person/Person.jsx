...
import { getPopularMovies, searchPerson } from '../../Api/moviesApi';
...
const Person = () => {
    ...
    useEffect(() => {
        const loadPopularMovies = async () => {
            try {
                const popularMovies = await getPopularMovies('person/popular', page);
    ...
    const handleSearch = async (e) => {
        ...
        setLoading(true);
        try {
            const searchResult = await searchPerson(search);
